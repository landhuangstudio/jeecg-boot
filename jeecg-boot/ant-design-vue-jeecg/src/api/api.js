...
//接单表
const addBill = (params)=>postAction("/buss/bill/add",params);
const editBill = (params)=>putAction("/buss/bill/edit",params);
const getBillList = (params)=>getAction("/buss/bill/list",params);
